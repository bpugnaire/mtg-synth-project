...
export function initTracks(loopLength): Track[] {
  return [
    {id: 1, name: "tabla-dhen", vol: 1, muted: false, beats: initBeats(loopLength)},
    {id: 2, name: "tabla-dhen", vol: 1, muted: false, beats: initBeats(loopLength)},
    {id: 3, name: "tabla-dhen", vol: 1, muted: false, beats: initBeats(loopLength)},
    {id: 4, name: "tabla-dhen", vol: 1, muted: false, beats: initBeats(loopLength)},
  ];
}
